...
classes = ["background", "aeroplane", "bycicle", "bird", "boat", "bottle", "bus", "car", "cat",
...
blob = cv2.dnn.blobFromImage(cv2.resize(image, (300, 300)), 0.007, (300,300), 13)
